...
public class ListViewAdapter extends BaseAdapter {
    ...
    private List<ShopDetails> worldpopulationlist = null;
    private ArrayList<ShopDetails> arraylist;

    public ListViewAdapter(Context context,
                           List<ShopDetails> worldpopulationlist) {
        mContext = context;
        this.worldpopulationlist = worldpopulationlist;
        inflater = LayoutInflater.from(mContext);
        this.arraylist = new ArrayList<ShopDetails>();
